...
**Example:** - Control_rep1.raw → Experiment: "Control", Bioreplicate: 1 - Control_rep2.raw → Experiment: "Control", Bioreplicate: 2\
- Control_rep3.raw → Experiment: "Control", Bioreplicate: 3 - Treatment_rep1.raw → Experiment: "Treatment", Bioreplicate: 1 - Treatment_rep2.raw → Experiment: "Treatment", Bioreplicate: 2 - Treatment_rep3.raw → Experiment: "Treatment", Bioreplicate: 3
